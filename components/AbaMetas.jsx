    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, flex: 1 }}>
      <div style={{
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 48 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#ffffff' }}>{title}</h2>
        ...
        <div style={{ position: 'relative', background: `${color}10`, padding: 20, borderRadius: 12, border: `1px solid ${color}30`, display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', minHeight: 80 }}>
          ...
          <div>
            <div style={{ fontSize: 18, color: '#ffffff', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 }}>Realizado Total</div>
            <div className="numeric" style={{ fontSize: 24, fontWeight: 400, letterSpacing: '-0.5px', color: '#ffffff' }}>{fmt(meta_realizada)}</div>
          </div>
        </div>
      ...
      {diasUteis > 0 && (
        <div style={{
          ...
          <div style={{ fontSize: 20, fontWeight: 600, color: '#ffffff', textTransform: 'uppercase', letterSpacing: 0.5, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 18, color: '#ffffff' }}>Dias Úteis Restantes</span>
            </div>
            <div className="numeric" style={{ fontSize: 18, fontWeight: 400, letterSpacing: '-0.5px', color: '#ffffff' }}>{diasUteis} <span style={{fontSize:18, fontWeight:400, color:'#ffffff'}}>dias</span></div>
          </div>
          
          <div style={{ height: 1, background: border, width: '100%' }}></div>
          
          <div>
            <div style={{ fontSize: 18, color: '#ffffff', marginBottom: 12 }}>
              Faturamento por dia
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div style={{ background: bgCardSecondary, padding: 12, borderRadius: 8, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 18, color: '#ffffff', marginBottom: 4 }}>Empresa</div>
                <div className="numeric" style={{ fontSize: 18, fontWeight: 400, letterSpacing: '-0.5px', color: '#ffffff' }}>
                  {fmt(necDiaEmpresa)}
                </div>
              </div>
              <div style={{ background: bgCardSecondary, padding: 12, borderRadius: 8, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 18, color: '#ffffff', marginBottom: 4 }}>Comercial</div>
                <div className="numeric" style={{ fontSize: 18, fontWeight: 400, letterSpacing: '-0.5px', color: '#ffffff' }}>
                  {fmt(necDiaComercial)}
                </div>
              </div>
